...
var wpAjaxUrl='http://chspromotion.se/traineedagen/wp-admin/admin-ajax.php';var flBuilderUrl='http://chspromotion.se/traineedagen/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://chspromotion.se/traineedagen/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://chspromotion.se/traineedagen/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var $element='undefined'==typeof element?$('body'):$(element),bxContent=$element.find('.bx-viewport > div'),bxObject=null;if(bxContent.length){bxObject=bxContent.data('bxSlider');if(bxObject){bxObject.reloadSlider();}}},resizeAudio:function(element)
